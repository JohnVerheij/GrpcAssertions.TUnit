...
For security vulnerabilities, use the repository's [private security advisory channel](https://github.com/JohnVerheij/GrpcAssertions.TUnit/security/advisories/new) instead; see [SECURITY.md](./SECURITY.md) for the full vulnerability-disclosure policy.
